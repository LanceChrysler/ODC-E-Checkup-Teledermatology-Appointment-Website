                    ...
                    <div class="card">
                        <form action="profile.php" method="post" enctype="multipart/form-data">
                            <div class="card-header">
                                ...
                                <a href="profile.php" class="btn btn-success float-end">Back</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-light caption-top">
                                    <tr>
                                        <th scope="row">Name</td>
                                        <td><input type="text" class="form-control" name="admin_name" value="<?php echo $admin['admin_name']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Sex</td>
                                        <td><select name="admin_sex" class="form-select" aria-label="Default select example">
                                                <option value=""></option>
                                                <option <?php if ($admin['admin_sex'] == "M") echo "selected"; ?> value="M">Male</option>
                                                <option <?php if ($admin['admin_sex'] == "F") echo "selected"; ?> value="F">Female</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Age</td>
                                        <td><input type="number" class="form-control" name="admin_age" value="<?php echo $admin['admin_age']; ?>" min="18" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Date of Birth</td>
                                        <td><input type="date" class="form-control" name="admin_birthdate" value="<?php echo $admin['admin_birthdate']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Phone</td>
                                        <td><input type="tel" class="form-control" name="admin_phone_no" value="<?php echo $admin['admin_phone_no']; ?>" maxlength="11" placeholder="09*********" oninput="this.value = this.value.replace(/[^0-9]/, '');" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Email</td>
                                        <td><input type="email" class="form-control" name="admin_email" value="<?php echo $admin['admin_email']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Address</td>
                                        <td><input type="text" class="form-control" name="admin_address" value="<?php echo $admin['admin_address']; ?>" />
                                        <td>
                                    </tr>
                                </table>
                                <button name="admin_profile" class="btn btn-success" type="submit">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
