...
$appointment_qry = "SELECT * FROM appointment_table JOIN patient_table ON appointment_table.patient_id = patient_table.patient_id WHERE appointment_status != 'Completed' AND doctor_id IS NULL";
                        ...
                        <div class="card-body">
                            <div class="container table-responsive-md">
                                <table class="table table-light table-hover caption-top">
                                    ...
                                    if ($row_count == 0) {
                                    ?>
                                        <strong>No Appointment Request</strong>
                                    <?php
                                    } else {
                                    ?>
                                        <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="#" method="post">
                                                            <input type="date" class="col-12 col-lg-4 btn btn-sm bg-secondary text-white" name="appointment_date" value="" min="2020-01-20" required />
