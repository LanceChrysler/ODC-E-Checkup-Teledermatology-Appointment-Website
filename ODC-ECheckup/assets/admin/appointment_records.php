...
$appointment_qry = "SELECT * FROM appointment_table JOIN patient_table ON appointment_table.patient_id = patient_table.patient_id JOIN doctor_table ON appointment_table.doctor_id = doctor_table.doctor_id WHERE appointment_status = 'Scheduled' ORDER BY appointment_date ASC";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="container table-responsive-md">
                                                        <table class="table table-light table-hover caption-top">
                                                            <?php
                                                            $appointment_qry = "SELECT * FROM appointment_table JOIN patient_table ON appointment_table.patient_id = patient_table.patient_id JOIN doctor_table ON appointment_table.doctor_id = doctor_table.doctor_id WHERE appointment_status = 'Completed' ORDER BY appointment_date ASC";
