...
$appointment_data = "SELECT * FROM appointment_table WHERE doctor_id='$sessionUser' AND appointment_status='Scheduled'";
		...
		<div class="container py-5">
			<div class="row">
				<div class="d-lg-flex align-items-center ">
					<!-- first column -->
					<div class="col px-5">
						<p class="head">Welcome to OUR Dermatology Clinic, <br><b><span class="text-primary">Dr. <?php if (!empty($doctor['doctor_name'])) echo $doctor['doctor_name'];
																													else echo $doctor['doctor_username']; ?></span></b>!</p>
						<hr>
